...
const LeafLoader = ({ mapName, markers = [], polylines = [] }) => {
  ...
  return(
    <MapContainer crs={L.CRS.Simple} maxBounds={bounds} maxBoundsViscosity={1} center={[-128, 128]} zoom={1} maxZoom={5} minZoom={.5} scrollWheelZoom={true} attributionControl={false} style={{ width: "100%", paddingBottom: "100%"}}>
      <TileLayer
        tileSize={256}
